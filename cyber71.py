...
\033[1;92m║✯ Facebook ✯ ANM Miah         ║    

\033[1;94m║✯ Team ✯ Team Cyber - 71 Official   ║   

\033[1;97m║✯ Facebook link ✯ https://www.facebook.com/access.darkweb.hacker         ║ 

\033[1;91m║✯ Team Group link ✯ https://www.facebook.com/groups/teamcyber71.official         ║ 
...
print  """
\033[1;97m******************************************************
\033[1;96m~ Cyber Security researchers at Team Cyber - 71  ~
\033[1;97m******************************************************
...
\033[1;96m╱╰┻━┻━━┻┻┻╯╰━╋╮┣━┻━┻╯╱╱╱╱╱╱╱┃╭╯┃┃
\033[1;96m╱╱╱╱╱╱╱╱╱╱╱╱╱╰━╯╱╱╱╱╱╱╱╱╱╱╱╱┃┃╭╯╰╮
 💓Another name for love ❤Team Cyber - 71❤
 🔥🔥
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-open https://www.facebook.com/groups/teamcyber71.official')
    else:
...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mYour Account Has Chakpoint")
...
def pilih():
	...
	if unikers =="":
		...
		os.system('clear')
		print logo
		print " \033[1;36;40m◄══════════════════Nazmul_Tufan══════════════════►\n"
...
def pilih_super():
	...
	print "   \033[1;92m◄══════════════════Tufan══════════════════►"

	jalan('          \033[1;91mStart Hacking Wait...')
	print  "  \033[1;92m ◄══════════════════Nazmul_Tufan══════════════════►" 
	...
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mNazmul-Tufan\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By Nazmul-Tufan--•◈•---»" #Dev:Nazmul-Tufan
	print '\033[1;93m✅Process Has Been Completed Press➡ Ctrl+Z.↩ Next Type (python2 BFS.py)↩\033[1;97m....'
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Nazmul Creations.. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91Team Cyber - 71"""
